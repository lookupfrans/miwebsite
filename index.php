        ...
        <div class="checkout-div" v-show="items.length > 0">
          ...
          <form action="validate.php" method="post" onsubmit="return validate(this);">
            <table border="0" cellspacing="1" cellpadding="3">
              ...
              <tr>
                <td>Kode Item : </td>
                <td> <input size="70" type="text" name="alamat2" autocomplete="on"><br>&nbsp;&nbsp;&nbsp;&nbsp;<i class="paragraph">*dipisah dengan notasi koma berurutan apabila lebih dari satu,&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp e.g. 01,02,05</i></td>
              </tr>
              <tr>
                <td>Kuantitas : </td>
                <td> <input size="70" type="text" name="alamat2" autocomplete="on"><br>&nbsp;&nbsp;&nbsp;&nbsp;<i class="paragraph">*dipisah dengan notasi koma berurutan apabila lebih dari satu</i></td>
              </tr>
              <tr>
                <td>Ukuran: </td>
                <td> <input size="70" type="text" name="alamat2" autocomplete="on"><br>&nbsp;&nbsp;&nbsp;&nbsp;<i class="paragraph">*dipisah dengan notasi koma berurutan apabila lebih dari satu</i></td>
